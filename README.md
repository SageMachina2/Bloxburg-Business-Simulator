...
Static fields are used to keep track on how many businesses are created, tracking and returning the business info, and much more. Static fields make it so that a variable is shared 
between every individual business instead of having each business have it's own variables to track.